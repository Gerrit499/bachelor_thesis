...
dataset = load_dataset("json", data_files="C:/Users/gerri/Documents/Documenten/jaar3/thesis/exp2/dataset_gpt/eng-fra_1_renamed.json", split="train")
...
training_args = TrainingArguments(
    output_dir="./finetuned_lora_model_engfra_high",
...
# 11 Save
model.save_pretrained("./finetuned_lora_model_engfra_high")
tokenizer.save_pretrained("./finetuned_lora_model_engfra_high")
print("Model saved!")
...
def load_finetuned_model():
    ...
    model = PeftModel.from_pretrained(base_model, "./finetuned_lora_model_engfra_high")
