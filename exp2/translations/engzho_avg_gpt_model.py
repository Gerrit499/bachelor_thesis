...
dataset = load_dataset("json", data_files="C:/Users/gerri/Documents/Documenten/jaar3/thesis/exp2/dataset_gpt/eng-zho_8_renamed.json", split="train")
...
# 2. Conservative PEFT configuration (small dataset)
...
training_args = TrainingArguments(
    output_dir="./finetuned_lora_model_engzho_medium",
...
# 11 Save
model.save_pretrained("./finetuned_lora_model_engzho_medium")
tokenizer.save_pretrained("./finetuned_lora_model_engzho_medium")
print("Model saved!")
...
# 13 Load for inference (combining base model with adapter)
def load_finetuned_model():
    ...
    model = PeftModel.from_pretrained(base_model, "./finetuned_lora_model_engzho_medium")
    model = model.merge_and_unload()  # Merge adapter weights with base model for faster inference
    return model

# 14 Compute log probability and perplexity
...
def generate_translation(model, tokenizer, prompt, strategy="greedy"):
    ...
    full_prompt = f"Translate the following English text to French:\nEnglish: {prompt}\nFrench:"
